...
hidden if the `common-control_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `common-control_DEVELOPER_MODE` to the configure
