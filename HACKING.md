...
hidden if the `control-common_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `control-common_DEVELOPER_MODE` to the configure
